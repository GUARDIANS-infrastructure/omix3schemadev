...
This guide covers the gen3schemadev commands used to develop and manage the Omix3 Gen3 data dictionary.
...
## 1. Create the input_yaml template
...
### 2.1 Further Gen3 YAML Configuration (optional)
...
## 5. Visualise the Gen3 Data Dictionary

**Important:** You must have [Docker Compose](https://docs.docker.com/compose/install/) installed. See [Setup](setup.md#prerequisites) for details.
